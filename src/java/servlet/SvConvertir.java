...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Cambiando de Millas a Km</title>");
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Conviertiendo de Millas a Km </h1>");
//            out.println("<p>usuario   : " + email +  " </p>");
//            out.println("<p>Contraseña: " + pass +  "</p>");
//            out.println("<p></p>");
//            out.println("<p>" + miles+ " millas = " + km +  " kilometros </p>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("mi", miles);
